    ...
    <div class="flex flex-col items-center justify-center">
        <form id='search-results' class="flex flex-no-wrap flex-row items-center gap-4" action="handleBookFetch" method="GET">
            <div class="flex flex-row items-center gap-2">
                <input form='search-result' id="search-input" type="text" name="r" placeholder="Search for a book...">
            ...
            <div class="flex flex-row items-center gap-2">
                <input form='search-result' id="search-year" type="number" name="y" placeholder="Year">
            ...
            <div>
                <a href="{{ route('form-book') }}" class="flex flex-row items-center gap-2 p-2 hover:bg-primary hover:text-secondary hover:fill-secondary">
                    +
