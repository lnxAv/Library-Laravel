...
Route::domain('api.' . env('APP_URL'))->group(function () {
    Route::prefix('v1')->group(function () {
        Route::prefix('books')->group(function () {
            ...
            //GET api/v1/books/sort/{order}
            Route::get('/sort/{order}', BookController::class . '@getBooksSorted')->name('api.v1.books.sort');
            //POST api/v1/books
        ...
        Route::prefix('messages')->group(function () {
            ...
            Route::delete('/{id}', MessagesController::class . '@deleteMessage')->name('api.v1.messages.delete');
        });
    });
});
